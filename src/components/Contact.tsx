  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`w-full h-full rounded-3xl border border-white/[0.06] bg-[#0a0a0a]/80 backdrop-blur-2xl shadow-2xl transition-all duration-300 ${className}`}
      >
        {children}
      </motion.div>
    </div>
  ...
  return (
    <div className="relative w-full">
      <input
        ...
        className={`w-full px-5 py-4 pt-6 pb-2 rounded-2xl border bg-transparent outline-none text-white ${error
          ? "border-red-500"
  ...
  return (
    <div className="relative w-full">
      <textarea
        ...
        className={`w-full min-h-[150px] resize-none px-5 py-4 pt-6 pb-2 rounded-2xl border bg-transparent outline-none text-white ${error
          ? "border-red-500"
          : "border-white/[0.08] focus:border-violet-500"
          }`}
      />
...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-[#050505] py-16 md:py-20"
    >
      {/* Background Grid */}
      ...
      >
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-violet-500/20 bg-violet-500/5 text-violet-400 text-xs font-bold uppercase tracking-widest"
        >
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          transition={{ delay: .1 }}
          className="mt-6 max-w-2xl text-neutral-400 leading-8"
        >
          {t("description")}
        </motion.p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="font-semibold text-white hover:text-violet-500 transition"
                    >
              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <div className="mt-2 flex justify-end">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="relative overflow-hidden w-full sm:w-auto px-8 py-4 rounded-2xl font-bold text-white bg-[#0a0a0a] border border-white/[0.08] flex items-center justify-center gap-3 transition-all duration-300 group cursor-pointer shadow-xl shadow-violet-500/10"
                    >
                ...
                >
                  ...
                  <div className="space-y-2">
                    <h4 className="text-2xl font-bold tracking-tight text-white">{t("msgTransmitted")}</h4>
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 rounded-xl border border-white/[0.08] hover:bg-white/[0.05] text-xs font-semibold text-neutral-300 transition-all duration-300 active:scale-95"
                  >
                    {t("btnAnother")}
                  </button>
                </motion.div>
